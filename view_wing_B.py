...
db = mysql.connector.connect(host="localhost", user='root',
                                 ...
                                 database="pythondata")
cur=db.cursor()
sql="select  student_hostel_gate_pass.hostel_gate_pass_id,student_name, stud_email,stud_wing,stud_room_no,mobile_no, reason_for_leave, departure_date,arrival_date, departure_time,arrival_time,stud_parent_name ,stud_parent_relation,parent_mobile_no ,parent_address,is_gate_pass_approved from student_hostel_gate_pass,stud_parents_info  where stud_wing='B' AND stud_wing='b' AND student_hostel_gate_pass.hostel_gate_pass_id=stud_parents_info.hostel_gate_pass_id"
cur.execute(sql)
